angular.module("angular.library", ["angular.library.tpls", "angular.library.directives.bar","angular.library.directives.foo","angular.library.directives.qix","angular.library.services.hello","angular.library.services.weather"]);
